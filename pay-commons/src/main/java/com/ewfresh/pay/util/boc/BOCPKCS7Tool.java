...
/*
 * @(#)BOCPKCS7Tool.java 1.0 2008-9-23
...
public class BOCPKCS7Tool {
	 ...
	 * @throws IOException 
	 */
	public static BOCPKCS7Tool getSigner(String keyStorePath, String keyStorePassword, String keyPassword)
		...
		BOCPKCS7Tool tool = new BOCPKCS7Tool(SIGNER);
	 ...
	 * @throws IOException 
	 */
	public static BOCPKCS7Tool getVerifier(String rootCertificatePath)
			throws GeneralSecurityException, IOException {
		init();
		//加载根证书
		FileInputStream fis = null;
		...
		BOCPKCS7Tool tool = new BOCPKCS7Tool(VERIFIER);
	...
	public String sign(byte[] data) throws Exception {
		if (mode != SIGNER)
			throw new IllegalStateException("call a BOCPKCS7Tool instance not for signature.");
...
//		public PKCS7(    sun.security.x509.AlgorithmId[] arg0, sun.security.pkcs.ContentInfo arg1, java.security.cert.X509Certificate[] arg2, sun.security.pkcs.SignerInfo[] arg3);
	...
	public void verify(String signature, byte[] data, String dn) throws IOException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, NoSuchProviderException  {
		if (mode != VERIFIER)
			throw new IllegalStateException("call a BOCPKCS7Tool instance not for verify.");
