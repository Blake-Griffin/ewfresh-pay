...
public class SDKConstants {
	...
	/** 支付卡标识，移动支付交易时，根据商户配置返回. */
	public static final String param_payCardNo = "payCardNo";
	/** 支付卡名称 C 移动支付交易时，根据商户配置返回. */
	public static final String param_payCardIssueName = "payCardIssueName";
	/** 自定义支付方式. */
	...
	/** 分账域*/
	public static final String param_accSplitData = "accSplitData";
	/** 支付失败时，页面跳转至商户该URL*/
	public static final String param_frontFailUrl = "frontFailUrl";
}
