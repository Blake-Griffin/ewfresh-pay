...
public class SDKConfig {
	...
	/** 前台请求URL. */
	private static String frontRequestUrl;
	/** 后台请求URL. */
	private static String backRequestUrl;
	/** 单笔查询 */
	private static String singleQueryUrl;
	/** 批量查询 */
	private static String batchQueryUrl;
	/** 批量交易 */
	private static String batchTransUrl;
	/** 文件传输 */
	...
	/** 按照商户代码读取指定签名证书目录. */
	private static String signCertDir;
	/** 磁道加密证书路径. */
	...
	/** backRefundUrl  退货的回调url*/
	private static String backRefundUrl;
	/** frontFailUrl  */
	private static String frontFailUrl;
	
	/*缴费相关地址*/
	private static String jfFrontRequestUrl;
	private static String jfBackRequestUrl;
	private static String jfSingleQueryUrl;
	private static String jfCardRequestUrl;
	private static String jfAppRequestUrl;
	...
	//综合认证
	private static String zhrzFrontRequestUrl;
	private static String zhrzBackRequestUrl;
	private static String zhrzSingleQueryUrl;
	private static String zhrzCardRequestUrl;
	private static String zhrzAppRequestUrl;
	private static String zhrzFaceRequestUrl;

	/** 易网聚鲜在银联B2C，web、wap的商户号*/
	...
	/** */
	private static String cardTransUrl;
	/** */
	private static String jfFrontTransUrl;
	/** */
	private static String jfBackTransUrl;
	/** */
	private static String jfCardTransUrl;
	/** */
	private static String jfAppTransUrl;
	...
	public String getBackRefundUrl() {
		return backRefundUrl;
	}

	public void setBackRefundUrl(String backRefundUrl) {
		SDKConfig.backRefundUrl = backRefundUrl;
	}
}
